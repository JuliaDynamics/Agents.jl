...
- The `add_agent!` function supports adding an agent propagating keywords arguments. Two versions of `add_agent!` have been deprecated to allow controlling the ids given to the agents, see issue #861.
