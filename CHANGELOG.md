...
- The `step` column in collected dataframes is been renamed to `time` because it described more generally what given the extension to continuous time models in this new release.
