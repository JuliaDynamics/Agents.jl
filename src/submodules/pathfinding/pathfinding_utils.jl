...
"""
function position_delta(pathfinder::GridPathfinder{D, true}, from::Dims{D},
                        to::Dims{D}) where {D}
    min.(abs.(to .- from), size(pathfinder.walkmap) .- abs.(to .- from))
end

function position_delta(pathfinder::GridPathfinder{D, false}, from::Dims{D},
                        to::Dims{D}) where {D}
    abs.(to .- from)
end
...
"""
function delta_cost(pathfinder::GridPathfinder{D, periodic, true},
                    metric::DirectDistance{D},
                    from::Dims{D},
                    to::Dims{D}) where {D, periodic}
...
function delta_cost(pathfinder::GridPathfinder{D, periodic, false},
                    metric::DirectDistance{D},
                    from::Dims{D},
                    to::Dims{D}) where {D, periodic}
...
function delta_cost(pathfinder::GridPathfinder{D},
                    metric::MaxDistance{D},
                    from::Dims{D},
                    to::Dims{D}) where {D}
    max(position_delta(pathfinder, from, to)...)
end
...
function delta_cost(pathfinder::GridPathfinder{D}, from::Dims{D}, to::Dims{D}) where {D}
