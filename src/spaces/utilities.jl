...
function chebyshev_distance(
    ...
    return maximum(chebyshev_distance_direct.(p1, p2))
end
...
function chebyshev_distance(
    ...
    s = spacesize(space)
    return maximum(chebyshev_distance_periodic.(p1, p2, s))
end
...
function manhattan_distance(
    ...
    return sum(manhattan_distance_direct.(p1, p2))
end
...
function manhattan_distance(
    ...
    return sum(manhattan_distance_periodic.(p1, p2, spacesize(space)))
end
