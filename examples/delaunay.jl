...
mdata = [
    count_red, count_blue, count_orange, count_total,
...
fig, ax, amobs = abmplot(
    model, agent_marker = cell -> voronoi_marker(model, cell), agent_color = voronoi_color,
