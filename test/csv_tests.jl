@testset "CSV" begin
    ...
    AgentsTestModels.SchellingAgent(id, p1, p2, mood, group) = AgentsTestModels.SchellingAgent(id, (p1, p2), mood, group)
    ...
    model = AgentsTestModels.schelling(; numagents = 10)
    empty_model = AgentsTestModels.schelling(; numagents = 0)
